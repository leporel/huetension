...
func newHarmonyCmd() *cobra.Command {
	...
	cmd.Flags().IntVarP(&hf.count, "count", "c", 0, "palette size; for hue harmonies extra slots cycle anchors with HSV tint/shade variations; defaults for analogous/monochromatic/shades: 3/5/5")
