...
<template>
  <div class="grid">
    ...
    <CardFrame id="wheel" title="Color wheel" :sub="`${harmony.type} · ${workspace.size} slots`" class="col-2">
      ...
      >
        ...
        <span>Independent S/V — non-base drags tweak saturation / value only</span>
      </label>
      <PaletteStrip />
      <ColorSliders />
    </CardFrame>

    <CardFrame id="color-picker" title="Color picker" sub="HSV" class="col-3">
      <ColorPicker />
    </CardFrame>
    ...
    <CardFrame id="extracted" title="Extracted palette" sub="frequency · saliency" class="col-3">
      <ExtractedPalette />
    </CardFrame>

    <CardFrame id="values" title="Values" sub="copy any format" class="col-1">
      <ColorOutput />
    </CardFrame>

    <CardFrame id="export" title="Export" sub="CSS · SCSS · Less · Tailwind" class="col-2-3">
      <PaletteExport />
    </CardFrame>

    <CardFrame id="gradient" title="Gradient" sub="multi-stop · interpolate" class="full">
      <GradientStudio />
    </CardFrame>

    <CardFrame id="blindness" title="Color blindness" sub="protan · deutan · tritan · achroma" class="full">
      <ColorBlindnessSim />
    </CardFrame>

    <CardFrame id="contrast" title="Contrast checker" sub="WCAG 2.1 · APCA" class="full">
      <ContrastChecker />
    </CardFrame>
  </div>
</template>
